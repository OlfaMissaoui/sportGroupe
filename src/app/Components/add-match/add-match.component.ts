...
export class AddMatchComponent implements OnInit {
  ...
  addMatch() {
    ...
    // let matchTab = JSON.parse(localStorage.getItem("matches") || "[]");
    // this.match.id =generateId(matchTab);
    //   matchTab.push(this.match);
    // localStorage.setItem("matches", JSON.stringify(matchTab));
